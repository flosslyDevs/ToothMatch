...
if (url) {
	...
	console.warn('No Postgres configuration found. Set DATABASE_URL (recommended) or PG* env vars.');
}
...
export async function connectToDatabase() {
	if (!sequelize) {
		console.warn('Skipping DB connection because no database URL is configured.');
		return null;
	}
	try {
