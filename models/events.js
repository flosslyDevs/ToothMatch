...
const Event = sequelize?.define('Event', {
	...
	// String arrays
	whatsIncluded: { type: DataTypes.ARRAY(DataTypes.STRING), allowNull: true, field: 'whats_included' },
	eventImages: { type: DataTypes.ARRAY(DataTypes.STRING), allowNull: true, field: 'event_images' },
